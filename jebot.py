...
@CWbot.on_message(filters.private & ~filters.bot & ~filters.command("help") & ~filters.command("start") & ~filters.command("s"))
...
@CWbot.on_message(filters.command("song") & ~filters.edited & filters.group)
async def song(client, message):
cap = "@CWbotZ"
...
@CWbot.on_message(filters.command("start"))
async def start(client, message):
if message.chat.type == 'private':
await CWbot.send_message(
...
@CWbot.on_message(filters.command("help"))
...
@CWbot.on_callback_query()
async def button(CWbot, update):
cb_data = update.data
if "help" in cb_data:
await update.message.delete()
await help(CWbot, update.message)
